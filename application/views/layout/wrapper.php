...
<head>
	...
	<link rel="stylesheet" href="<?=base_url('assets/new/css/select2.min.css')?>" />
		...
		<div class="navbar-buttons navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				<li class="light-blue dropdown-modal">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background-color:#2eb82e"><?=$this->session->userdata('username') != '' ? $this->session->userdata('username'):'User'?> &nbsp;
